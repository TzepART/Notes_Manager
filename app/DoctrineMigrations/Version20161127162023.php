 ...
 */
class Version20161127162023 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(60) NOT NULL, username VARCHAR(25) NOT NULL, password VARCHAR(64) NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, logged DATETIME DEFAULT NULL, roles VARCHAR(45) DEFAULT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
