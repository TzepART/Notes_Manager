...
CREATE TABLE IF NOT EXISTS `symfony`.`circle` (
  ...
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_circle_users1_idx` (`users_id` ASC)  COMMENT '',
...
-- -----------------------------------------------------
-- Table `symfony`.`colors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `symfony`.`colors` (
  `id` INT NOT NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `symfony`.`sectors` (
  ...
  `date_create` DATETIME NULL COMMENT '',
  `date_update` DATETIME NULL COMMENT '',
  `colors_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_sectors_circle1_idx` (`circle_id` ASC)  COMMENT '',
  INDEX `fk_sectors_colors1_idx` (`colors_id` ASC)  COMMENT '',
  CONSTRAINT `fk_sectors_circle1`
    FOREIGN KEY (`circle_id`)
    REFERENCES `symfony`.`circle` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sectors_colors1`
    FOREIGN KEY (`colors_id`)
    REFERENCES `symfony`.`colors` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `symfony`.`rays`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `symfony`.`rays` (
  `id` INT NOT NULL COMMENT '',
  `angle` FLOAT NULL COMMENT '',
  `date_create` DATETIME NULL COMMENT '',
  `date_update` DATETIME NULL COMMENT '',
  `sectors_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_rays_sectors1_idx` (`sectors_id` ASC)  COMMENT '',
  CONSTRAINT `fk_rays_sectors1`
...
CREATE TABLE IF NOT EXISTS `symfony`.`layers` (
  ...
  INDEX `fk_layers_colors1_idx` (`colors_id` ASC)  COMMENT '',
  CONSTRAINT `fk_layers_circle1`
    FOREIGN KEY (`circle_id`)
    REFERENCES `symfony`.`circle` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_layers_colors1`
    FOREIGN KEY (`colors_id`)
    REFERENCES `symfony`.`colors` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `symfony`.`radius`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `symfony`.`radius` (
  `id` INT NOT NULL COMMENT '',
  `radius` FLOAT NULL COMMENT '',
  `date_create` DATETIME NULL COMMENT '',
  `date_update` DATETIME NULL COMMENT '',
  `layers_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_radius_layers1_idx` (`layers_id` ASC)  COMMENT '',
  CONSTRAINT `fk_radius_layers1`
...
CREATE TABLE IF NOT EXISTS `symfony`.`labels` (
  ...
  `date_create` DATETIME NULL COMMENT '',
  `date_update` DATETIME NULL COMMENT '',
  `rays_id` INT NOT NULL COMMENT '',
  `radius_id` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
  INDEX `fk_labels_rays1_idx` (`rays_id` ASC)  COMMENT '',
  INDEX `fk_labels_radius1_idx` (`radius_id` ASC)  COMMENT '',
  CONSTRAINT `fk_labels_rays1`
    FOREIGN KEY (`rays_id`)
    REFERENCES `symfony`.`rays` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_labels_radius1`
    FOREIGN KEY (`radius_id`)
    REFERENCES `symfony`.`radius` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
